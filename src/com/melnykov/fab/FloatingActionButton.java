...
//        }
    ...
    private void initAttributes(Context context, AttributeSet attributeSet) {
        ...
        if (attr != null) {
            try {
                mColorNormal = attr.getColor(R.styleable.FloatingButton_fab_colorNormal,
                        getColor(android.R.color.transparent));
                mColorPressed = attr.getColor(R.styleable.FloatingButton_fab_colorPressed,
                        darkenColor(mColorNormal));
                mColorRipple = attr.getColor(R.styleable.FloatingButton_fab_colorRipple,
                        lightenColor(mColorNormal));
                mColorDisabled = attr.getColor(R.styleable.FloatingButton_fab_colorDisabled,
                        mColorDisabled);
                mShadow = attr.getBoolean(R.styleable.FloatingButton_fab_shadow, true);
                mType = attr.getInt(R.styleable.FloatingButton_fab_type, TYPE_NORMAL);
            } finally {
                attr.recycle();
            }
        }
