...
public class ListViewFragmentLayout extends BaseFragment2 implements OnRefreshListener2 {
	...
	public void onChildViewLoaded() {
		...
		if(rltEmpty!=null){
			RelativeLayout.LayoutParams params = (LayoutParams) rltEmpty.getLayoutParams();
			params.topMargin = getResources().getDimensionPixelOffset(R.dimen.title_height)+getResources().getDimensionPixelOffset(R.dimen.main_menu_height);
			rltEmpty.setLayoutParams(params);
		}
		if(rltError!=null){
			RelativeLayout.LayoutParams params = (LayoutParams) rltError.getLayoutParams();
			params.topMargin = getResources().getDimensionPixelOffset(R.dimen.title_height)+getResources().getDimensionPixelOffset(R.dimen.main_menu_height);
			rltError.setLayoutParams(params);
		}
		onReloadData();
		Utils.addHeaderAndFooterCutline(houselist.getRefreshableView());
	}
