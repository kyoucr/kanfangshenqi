...
public class AlertWidget {
	...
	public void setThirdListener(String btnTXT, DialogInterface.OnClickListener third) {
	 ...
	 *            取消按钮触发的事件
	 *******************************/
	public void setCancelListener(String btnTXT, DialogInterface.OnClickListener Canel) {
	...
	private Animation getRootateAnim(){
		if(an == null){
	...
	public void showBar() {
		...
		if (window != null) {
			imgBar = (ImageView) window.findViewById(R.id.bar);
			imgBar.startAnimation(getRootateAnim());
		}
	}
	 ...
	 ********************
	 */
	public void showCustom(String title, String content, String txtCancelBtn, String txtOkBtn,
	...
	public void showLogin() {
		showCustom(null, context.getString(R.string.alert_unlogin), context.getString(R.string.txt_cancel),
