...
public class ZhaoFangFragment extends BaseFragment2 implements Response.ErrorListener, OnClickListener {
	...
	public void onClick(View view) {
		...
		if (mapFragment.popupwindow != null && mapFragment.popupwindow.isShowing())
			mapFragment.popupwindow.dismiss();
		switch (view.getId()) {
		/**
		 * 
		 */
	...
	public boolean onBackPressed() {
		if (mMenu != null && mMenu.mPopupWindow != null && mMenu.mPopupWindow.isShowing()) {
			mMenu.mPopupWindow.dismiss();
			return true;
		}
