...
public class MapFragmentLayout extends BaseFragment2 implements LocationSource, OnCameraChangeListener,
	...
	public void onPlanAddEvent(UnPlan unPlan) {
		...
		if (unPlan != null && unPlan.getBuildingId() != null && dataListCurrentShowPop != null
				&& unPlan.getBuildingId().equals(dataListCurrentShowPop.getBuildingId())) {
			if (jihua != null) {
	...
	private DataList dataListCurrentShowPop;

	// 楼盘详情信息显示
	private void initPopuWindow(View parent, final DataList dataList) {
		dataListCurrentShowPop = dataList;
		...
		if (!isPlan || Utils.getHeaderParamsOnly() == null) {
